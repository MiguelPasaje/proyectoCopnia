...
<div class="shadow-lg p-3 mb-5 bg-body rounded " style="margin:5%;">
    ...
    <div class="row">
        <div class="col-sm-4 col-sm-5 col-lg-4 " style="padding: 2%;">
            <h1 >
                Juan Felipe Hidalgo
            </h1>
        ...
        <div class="col-sm-4 col-md-5 offset-md-4 col-lg-4 offset-lg-0" style="padding: 2%;">
            <h1>
                Miguel Andres Pasaje
            </h1>
        ...
        <div class="col-sm-4 col-md-5 offset-md-2 col-lg-4 offset-lg-0" style="padding: 2%;">
            <h1>
                Carlos Andres Gudiño
            </h1>
    
            <img src="https://scontent.fclo1-1.fna.fbcdn.net/v/t1.0-9/117822539_1767195766779646_5060493221132430053_n.jpg?_nc_cat=100&ccb=3&_nc_sid=09cbfe&_nc_ohc=eElHQyxUqY0AX9ORC79&_nc_ht=scontent.fclo1-1.fna&oh=7eda6ba9883d07b57f1534decad41855&oe=60505733" alt="">
        </div>
      </div>
